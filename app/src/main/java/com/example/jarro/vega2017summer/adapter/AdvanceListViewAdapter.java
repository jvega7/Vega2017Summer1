...
import com.example.jarro.vega2017summer.util.UtilDensity;
...
public class AdvanceListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            viewHolder.tv = (TextView)convertView.findViewById(R.id.activity_advance_list_view_tv);
